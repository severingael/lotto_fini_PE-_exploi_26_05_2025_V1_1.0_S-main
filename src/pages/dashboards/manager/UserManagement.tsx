...
import { Search, Edit, AlertCircle, X, Save, Lock, Unlock, Power, PowerOff, Filter, Printer } from 'lucide-react';
...
export default function UserManagement() {
  ...
  const fetchUsers = async () => {
    try {
      ...
      const stats = {
        ...
        agents: usersData.filter(u => u.role === 'agentuser').length,
        staff: usersData.filter(u => u.role === 'staffuser').length,
  ...
  const filteredUsers = users.filter(user => {
    ...
    const matchesRole = roleFilter === 'all' || 
      (roleFilter === 'agent' && user.role === 'agentuser') ||
      (roleFilter === 'staff' && user.role === 'staffuser');
