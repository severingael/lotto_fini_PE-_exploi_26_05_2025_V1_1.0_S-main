...
export default function Lotto() {
  ...
  const [currentParticipation, setCurrentParticipation] = useState<LottoParticipation | null>(null);
  ...
  const handleParticipate = async (selectedNumbers: number[]) => {
    ...
    try {
      ...
      const newParticipation: LottoParticipation = {
        id: participationId,
        lottoId: selectedLotto.id!,
        userId: currentUser.uid,
        selectedNumbers,
      ...
      setCurrentParticipation(newParticipation);
  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-24 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        {currentParticipation && showTicketModal && (
          <TicketModal
            isOpen={showTicketModal}
            onClose={handleTicketModalClose}
            participation={currentParticipation}
            playerName={currentUser?.email || 'Client'}
            gameParameters={{
              eventName: selectedLotto?.eventName || '',
              numbersToSelect: selectedLotto?.numbersToSelect || 6,
              endDate: selectedLotto?.endDate || ''
            }}
          />
        )}
